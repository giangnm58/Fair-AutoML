...
def create_baseline(default_models,dataset_orig, privileged_groups,unprivileged_groups,
        ...
        for degree in degrees:
            ...
            for name,o in odds.items():
                ...
                for _ in range(repetitions):
                    ...
                    if class_metric.disparate_impact()!= 0:
                        di = abs(math.log(class_metric.disparate_impact()))
                    else:
                    ...
                    hist.append([class_metric.accuracy(),di, stat, eod, aod])
