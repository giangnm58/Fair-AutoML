...
automl = autosklearn.classification.AutoSklearnClassifier(
    ...
    ensemble_size=1,
    include_preprocessors=['extra_trees_preproc_for_classification', 'select_rates_classification', 'kernel_pca'],
...
a_file = open("german_knn_aod" + str(now) + "60sp.pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_german_knn_aod" + str(now) + "60sp.pkl", "wb")
