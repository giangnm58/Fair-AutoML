...
class CustomRandomForest(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        n_estimators = UniformIntegerHyperparameter("n_estimators", 273, 799, default_value=273)
        ...
        max_features = UniformFloatHyperparameter(
            "max_features", 0.22121, 0.77111, default_value=0.5)
...
automl = autosklearn.classification.AutoSklearnClassifier(
    ...
    ensemble_size=1,
    include_preprocessors=['nystroem_sampler', 'select_rates_classification', 'random_trees_embedding'],
...
a_file = open("german_rf_di" + str(now) + "60sp.pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_german_rf_di" + str(now) + "60sp.pkl", "wb")
