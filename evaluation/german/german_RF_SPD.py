...
class CustomRandomForest(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        n_estimators = UniformIntegerHyperparameter("n_estimators", 211, 735, default_value=211)
        ...
        max_features = UniformFloatHyperparameter(
            "max_features", 0.18722, 0.71275, default_value=0.5)
...
automl = autosklearn.classification.AutoSklearnClassifier(
    ...
    ensemble_size=1,
    include_preprocessors=['pca', 'kernel_pca', 'extra_trees_preproc_for_classification'],
...
a_file = open("german_rf_sod" + str(now) + "60sp.pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_german_rf_sod" + str(now) + "60sp.pkl", "wb")
