...
class CustomRandomForest(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        n_estimators = UniformIntegerHyperparameter("n_estimators", 190, 781, default_value=190)
        ...
        max_features = UniformFloatHyperparameter(
            "max_features", 0.13233, 0.73855, default_value=0.5)
...
automl = autosklearn.classification.AutoSklearnClassifier(
    ...
    ensemble_size=1,
    include_preprocessors=['feature_agglomeration', 'select_rates_classification', 'random_trees_embedding'],
...
a_file = open("adult_rf_di_60sp" + str(now) + ".pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_adult_rf_di_60sp" + str(now) + ".pkl", "wb")
