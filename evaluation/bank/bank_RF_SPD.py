...
class CustomRandomForest(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        n_estimators = UniformIntegerHyperparameter("n_estimators", 244, 758, default_value=244)
        ...
        max_features = UniformFloatHyperparameter(
            "max_features", 0.19683, 0.75980, default_value=0.5)
...
automl = autosklearn.classification.AutoSklearnClassifier(
    ...
    ensemble_size=1,
    include_preprocessors=['select_rates_classification', 'feature_agglomeration', 'extra_trees_preproc_for_classification'],
...
a_file = open("bank_rf_spd" + str(now) + "60sp.pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_bank_rf_spd" + str(now) + "60sp.pkl", "wb")
