...
# train.to_pickle("data_orig_train10.pkl")
# test.to_pickle("data_orig_test10.pkl")
#
# X_train = data_orig_train.features
# y_train = data_orig_train.labels.ravel()
#
...
class CustomRandomForest(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        n_estimators = UniformIntegerHyperparameter("n_estimators", 514, 1686, default_value=1686)
        ...
        max_features = UniformFloatHyperparameter(
            "max_features", 0.42868, 0.85788, default_value=0.5)
...
automl = autosklearn.classification.AutoSklearnClassifier(
    ...
    ensemble_size=1,
    include_preprocessors=['extra_trees_preproc_for_classification', 'kernel_pca', 'fast_ica'],
...
# ===================================
a_file = open("titanic_rf_aod_60sp" + str(now) + ".pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_titanic_rf_aod_60sp" + str(now) + ".pkl", "wb")
