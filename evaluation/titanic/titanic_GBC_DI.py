...
now = now.replace(":", "_")
temp_path = "titanic_gbc_di" + str(now)
try:
...
automl = autosklearn.classification.AutoSklearnClassifier(
    ...
    ensemble_size=1,
    include_preprocessors=['kernel_pca', 'fast_ica', 'select_percentile_classification'],
...
# ===================================
a_file = open("titanic_gbc_di_60sp" + str(now) + ".pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_titanic_gbc_di_60sp" + str(now) + ".pkl", "wb")
